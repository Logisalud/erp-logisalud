  ...
  return (
    <main className="max-w-2xl mx-auto mt-20 px-4">
      ...
      <div className="grid gap-4">
        <Link href="/importar" className="block p-6 bg-white rounded-xl border border-gray-200 hover:border-blue-400 hover:shadow-sm transition">
        ...
        <Link href="/importar-cartera" className="block p-6 bg-white rounded-xl border border-gray-200 hover:border-blue-400 hover:shadow-sm transition">
        ...
        <Link href="/clientes" className="block p-6 bg-white rounded-xl border border-gray-200 hover:border-blue-400 hover:shadow-sm transition">
