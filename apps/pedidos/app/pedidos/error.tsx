...
export default function PedidosError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <div className="card-highlight flex flex-col gap-3 p-6">
      ...
      <p className="text-sm text-gray-600">
        Hubo un problema al cargar los datos del pedido. Intenta de nuevo; si el problema
        sigue, avisa al administrador con el código de error.
      </p>
