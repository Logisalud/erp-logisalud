  ...
  return (
    <main className="max-w-2xl mx-auto mt-20 px-4">
      ...
      <div className="grid gap-4">
        <Link href="/cobranzas/estado-cuenta" className="block p-6 bg-white rounded-xl border-2 hover:shadow-md transition" style={{ borderColor: '#4BB168' }}>
        ...
        <Link href="/cobranzas/importar" className="block p-6 bg-white rounded-xl border border-gray-200 hover:border-gray-300 hover:shadow-sm transition">
        ...
        <Link href="/cobranzas/importar-cartera" className="block p-6 bg-white rounded-xl border border-gray-200 hover:border-gray-300 hover:shadow-sm transition">
        ...
        <Link href="/cobranzas/conciliacion" className="block p-6 bg-white rounded-xl border border-gray-200 hover:border-gray-300 hover:shadow-sm transition">
        ...
        <Link href="/cobranzas/pagos-sin-confirmar" className="block p-6 bg-white rounded-xl border-2 hover:shadow-md transition" style={{ borderColor: '#e5a83c' }}>
        ...
        <Link href="/cobranzas/concentracion-cartera" className="block p-6 bg-white rounded-xl border border-gray-200 hover:border-gray-300 hover:shadow-sm transition">
        ...
        <Link href="/cobranzas/efectivo-por-depositar" className="block p-6 bg-white rounded-xl border-2 hover:shadow-md transition" style={{ borderColor: '#e5a83c' }}>
