  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-8">
      ...
      <section className="card">
        ...
        exigeRespuestaDetraccion(obligacion.total, obligacion.moneda as Moneda) ? (
          <p className="mt-3 rounded-md border border-amber-200 bg-amber-50 px-3 py-2.5 text-sm text-amber-900">
            El total supera S/ {UMBRAL_DETRACCION_PEN} y no tiene detracción cargada — revisa si
            corresponde (Anexo 3 SUNAT) antes de dar conformidad. (Obligación de antes de que esta
            pregunta fuera obligatoria al registrar.)
          </p>
        ) : null}
        {obligacion.oc ? (
