...
export const metadata = { title: 'Iniciar sesión — Compras y Pagos' }

export default function LoginPage({ searchParams }: { searchParams: { volver_a?: string } }) {
  // Solo rutas internas, para que un link armado a mano no pueda usar el login
