...
import { crearAporteAction, type EstadoFormulario } from './actions'
...
/**
 * Registrar un gasto que el accionista pagó de su bolsillo y NO reclama.
 *
 * La pantalla dice explícitamente que esto no genera ninguna deuda: es lo
 * único que la distingue de "Pedir un pago", y si no se dice, alguien va a
 * quedarse esperando un reembolso que nunca va a llegar.
 */
export function FormularioAporte({
  categorias,
  inicial,
  accionServidor = crearAporteAction,
